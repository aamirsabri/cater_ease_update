                    ...
                    Padding(
                      ...
                      child: ElevatedButton(
                        ...
                        child: Row(
                          mainAxisAlignment: MainAxisAlignment.center,
                          children: [
                            Text(Languages.of(context)?.loginLabel ?? AppStrings.loginLabel,style: getSemiBoldStyle(fontColor: ColorManager.secondaryFont,fontSize: FontSize.mediumLargeSize),),
                          ],
                        ),
                        ),
                    ),
                ...
                Row(
                  ...
                  children: [
                    Padding(
                      ...
                      child: Text(AppStrings.dontHaveAccount,style: getSemiBoldStyle(fontColor: ColorManager.primaryFontOpacity70),),
                    ),
                    Padding(
                      padding: EdgeInsets.all(AppPadding.p8),
                      child: TextButton(
                          ...
                          child: Text(Languages.of(context)?.registerLabel ?? AppStrings.registerLabel,
                              style: getBoldStyle(fontColor: ColorManager.primary,fontSize: FontSize.mediumLargeSize))),
                    ),
                  ],
                ),

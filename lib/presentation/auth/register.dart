...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  signUpUser() async{
    if(_formKey.currentState?.validate()?? false){
      String res = await _registerViewModelController.signUpUser(_userNameController.text, _emailController.text, _passwordConroller.text,_phoneController.text,_catererController.text,_placeController.text);
      EasyLoading.dismiss();
      if(res == "success"){
        showSnack(context,Languages.of(context)?.successfullySignedUp ?? AppStrings.successfullySignedUp);      
              ...
              Container(
                ...
                child: Center(
                  child: Column(
                    ...
                    children: [
                      Text(Languages.of(context)?.appName ?? AppStrings.appName,style: getBoldStyle(fontColor: ColorManager.secondaryFont,fontSize: FontSize.extraBigSize),),
                      Text(Languages.of(context)?.appTag ?? AppStrings.appTag,style: getBoldStyle(fontColor: ColorManager.secondaryFont,),)
                    ],
                  ),
                ),
              ),
              ...
              Padding
                  (
                    ...
                    child: TextFormField(
                      ...
                      decoration: InputDecoration(
                        labelText: Languages.of(context)?.usernameHint ?? AppStrings.usernameHint 
                      ),
                    ),
                  ),
                  Padding
                  (
                    ...
                    child: TextFormField(
                      ...
                      decoration: InputDecoration(
                        labelText: Languages.of(context)?.mobileHint ?? AppStrings.mobileHint 
                      ),
                    ),
                  ),
              Padding
                  (
                    ...
                    child: TextFormField(
                      ...
                      decoration: InputDecoration(
                        labelText: Languages.of(context)?.emailHint ?? AppStrings.emailHint 
                      ),
                    ),
                  ),
                  Padding
                  (
                    ...
                    child: TextFormField(
                      ...
                      decoration: InputDecoration(
                        labelText: Languages.of(context)?.catererName ?? AppStrings.catererName 
                      ),
                    ),
                  ),
               ...
               Padding
                  (
                    ...
                    child: TextFormField(
                      ...
                      decoration: InputDecoration(
                        labelText: Languages.of(context)?.passwordHint ?? AppStrings.passwordHint 
                      ),
                    ),
                  ),
                   Padding
                  (
                    ...
                    child: TextFormField(
                      ...
                      decoration: InputDecoration(
                        labelText: Languages.of(context)?.confirmPasswordHint ?? AppStrings.confirmPasswordHint
                      ),
                    ),
                  ),
                   Padding
                  (
                    ...
                    child: TextFormField(                      
                      ...
                      decoration: InputDecoration(
                        labelText: Languages.of(context)?.placeNameHint ?? AppStrings.placeNameHint
                      ),
                    ),
                  ),
      ...
      bottomSheet: Padding(
                    ...
                    child: ElevatedButton(
                      ...
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                          Text(Languages.of(context)?.registerLabel ?? AppStrings.registerLabel,style: getSemiBoldStyle(fontColor: ColorManager.secondaryFont,fontSize: FontSize.mediumLargeSize),),
                        ],
                      ),
                      ),
                  ),
